  ...
  class s {
    ...
    async loadModel(t, s, n) {
      if (localStorage.setItem('modelId', t),
          localStorage.setItem('modelTexturesId', s), o(n, 4e3, 10),
          this.useCDN) {
    ...
    async loadOtherModel() {
      ...
      if (this.useCDN) {
        ...
        fetch(`${this.apiPath}switch/?id=${e}`)
            .then((e => e.json()))
            .then((e => {this.loadModel(e.model.id, 0, e.model.message)}))
    }
  }
  const n =
      {
        hitokoto: {
          icon:
              '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">\x3c!--! Font Awesome Free 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. --\x3e<path d="M512 240c0 114.9-114.6 208-256 208c-37.1 0-72.3-6.4-104.1-17.9c-11.9 8.7-31.3 20.6-54.3 30.6C73.6 471.1 44.7 480 16 480c-6.5 0-12.3-3.9-14.8-9.9c-2.5-6-1.1-12.8 3.4-17.4l0 0 0 0 0 0 0 0 .3-.3c.3-.3 .7-.7 1.3-1.4c1.1-1.2 2.8-3.1 4.9-5.7c4.1-5 9.6-12.4 15.2-21.6c10-16.6 19.5-38.4 21.4-62.9C17.7 326.8 0 285.1 0 240C0 125.1 114.6 32 256 32s256 93.1 256 208z"/></svg>',
          callback: function() {
            fetch('https://v1.hitokoto.cn').then((e => e.json())).then((e => {
              const t = `这句一言来自 <span>「${e.from}」</span>，是 <span>${
                  e.creator}</span> 在 hitokoto.cn 投稿的。`;
              o(e.hitokoto, 6e3, 9), setTimeout((() => {o(t, 4e3, 9)}), 6e3)
            }))
          }
        },
        asteroids: {
  ...
  function i(t) {
    ...
    function c(t) {
      ...
      window.addEventListener('mousemove', (() => n = !0)),
          ...
          setInterval(
              (() => {
                   n ? (n = !1, clearInterval(s), s = null) :
                       s || (s = setInterval((() => {o(i, 6e3, 9)}), 2e4))}),
              1e3),
          o(
              function(e) {
                if ('/' === location.pathname)
                  for (let {hour: t, text: o} of e) {
                    const e = new Date, s = t.split('-')[0],
                          n = t.split('-')[1] || s;
      ...
      console.log('%c', c),
          ...
          window.addEventListener('copy', (() => {o(t.message.copy, 6e3, 9)})),
          window.addEventListener(
              'visibilitychange',
              (() => {
    ...
    localStorage.removeItem('waifu-display'),
        ...
        setTimeout(
            (() => {document.getElementById('waifu').style.bottom = 0}), 0),
        function() {
          ...
          for (let e of t.tools)
            if (n[e]) {
              ...
              document.getElementById('waifu-tool')
                  .insertAdjacentHTML(
                      'beforeend', `<span id="waifu-tool-${e}">${t}</span>`),
                  document.getElementById(`waifu-tool-${e}`)
        ...
        function() {
          ...
          null === e && (e = 1, o = 53), i.loadModel(e, o),
  ...
  window.initWidget = function(e, t) {
    ...
    o.addEventListener(
        ...
        (o.setAttribute('first-time', !0),
         setTimeout((() => {o.classList.add('waifu-toggle-active')}), 0)) :
        i(e)
  }
}();
